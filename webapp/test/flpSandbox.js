		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comfioritrainingtrainingproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comfioritrainingtrainingproject-display": {
								"semanticObject": "comfioritrainingtrainingproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.fiori.training.trainingproject",
									"url": sap.ui.require.toUrl("com/fiori/training/trainingproject")
								}
							}
						}
					}
